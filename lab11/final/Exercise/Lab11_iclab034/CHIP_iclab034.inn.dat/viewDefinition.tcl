...
create_analysis_view -name av_func_mode_min -constraint_mode func_mode -delay_corner Delay_Corner_max -latency_file ${::IMEX::dataVar}/mmmc/views/av_func_mode_min/latency.sdc
