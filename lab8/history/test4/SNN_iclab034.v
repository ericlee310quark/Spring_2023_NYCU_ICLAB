...
always @(*) begin
	...
	ctrl_maxmap0 = !((next_state==S_INPUT_1|current_state==S_INPUT_2|current_state==S_CNN_2)&(cnt<'d2|(cnt=='d25)));
	//ctrl_maxmap1 = 'b1;
	//ctrl_maxmap1 = !(next_state==S_INPUT_2|next_state==S_CNN_2|next_state==S_NN_1|next_state==S_NN_2|current_state==S_NN_2);
	ctrl_nn1a = !(next_state==S_INPUT_1&(cnt>'d25&cnt<'d28));
	ctrl_nn1b = !(next_state==S_INPUT_2&(cnt>'d1&cnt<'d5));
	ctrl_nn2a = !(next_state==S_INPUT_2&(cnt>'d25&cnt<'d28));
	ctrl_nn2b = !(next_state==S_NN_2);
end
...
always@(*)begin
	mult_a[0] =  (cg_en&~(cnt<'d2|cnt>'d14))?'b0:(current_state<'d4)?img0[0]:max_map_new[0]; //max_map1[1][0];
	mult_b[0] = (cg_en&~(cnt<'d2|cnt>'d14))?'b0:(current_state<'d4)?kernel[0][0]:weight_map[0][0];
	mult_a[1] = (cg_en&~(cnt<'d2|cnt>'d14))?'b0:(current_state<'d4)?img0[1]:max_map_new[1];//max_map1[1][1];
	mult_b[1] = (cg_en&~(cnt<'d2|cnt>'d14))?'b0:(current_state<'d4)?kernel[0][1]:weight_map[0][1];

	mult_a[2] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:img0[2];
	mult_b[2] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:kernel[0][2];
	mult_a[3] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:img0[6];
	mult_b[3] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:kernel[1][0];
	mult_a[4] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:img0[7];
	mult_b[4] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:kernel[1][1];
	mult_a[5] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:img0[8];
	mult_b[5] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:kernel[1][2];
	mult_a[6] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:img0[12];
	mult_b[6] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:kernel[2][0];
	mult_a[7] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:img0[13];
	mult_b[7] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:kernel[2][1];
	mult_a[8] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:img0[14];
	mult_b[8] = (cg_en&~((cnt<'d2|cnt>'d14)&current_state<'d4))?'b0:kernel[2][2];
