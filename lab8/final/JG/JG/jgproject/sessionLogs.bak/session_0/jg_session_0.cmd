...
# ----------------------------------------
# started   : 2023-04-24 12:25:23 CST
# hostname  : ee24.EEHPC
# pid       : 209675
# arguments : '-label' 'session_0' '-console' '//127.0.0.1:33250' '-style' 'windows' '-data' 'AAAAnHicY2RgYLCp////PwMYMFcBCQEGHwZfhiAGVyDpzxAGpOGA8QGUYcPIgAwYAxtQaAYGVphCKM0ExBwMugzFDKkMyUC2HEMWQzpDPJQfz1DEUMqQx2DEoMdQAuTnAFVwAQBjlxEN' '-proj' '/RAID2/COURSE/iclab/iclab034/Lab08/JG/jgproject/sessionLogs/session_0' '-init' '-hidden' '/RAID2/COURSE/iclab/iclab034/Lab08/JG/jgproject/.tmp/.initCmds.tcl' 'jg_sec_run2.tcl'
clear -all 
...
check_sec -prove -bg
visualize -violation -property {<embedded>::out_data[9:0]} -new_window
