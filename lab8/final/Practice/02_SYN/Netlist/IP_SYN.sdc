...
# Created by write_sdc on Thu Apr 20 19:24:38 2023
...
{out_number[0]}]]
set_false_path   -from [get_clocks clk]  -to [list [get_cells GATED_midp/latch_or_sleep_reg] [get_cells                \
GATED_mean/latch_or_sleep_reg] [get_cells GATED_shar/latch_or_sleep_reg]       \
[get_cells GATED_input/latch_or_sleep_reg]]
