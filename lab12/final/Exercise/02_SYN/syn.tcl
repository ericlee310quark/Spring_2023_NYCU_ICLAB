...
#  Output Reports 
#======================================================
check_design > Report/QUEEN.check
report_timing >  Report/QUEEN.timing
report_area >  Report/QUEEN.area
report_resource >  Report/QUEEN.resource
...
write_sdf -version 3.0 -context verilog -load_delay cell Netlist/QUEEN_SYN.sdf -significant_digits 6
write_sdc Netlist/QUEEN_SYN.sdc
